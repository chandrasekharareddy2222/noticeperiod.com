...
const materialWidgetRoutes: Routes = [
    ...
    { path: 'tracker', component:  TrackerComponent ,data: { animation: 'tracker' } },
    { path: 'chat', component:  ChatComponent ,data: { animation: 'chat' } },
    { path: 'preference', component:  PreferencesComponent ,data: { animation: 'preference' } },
    { path: 'dropdown', component:  DropdownComponent ,data: { animation: 'dropdown' } },
    { path: 'signup', component:  SignupComponent ,data: { animation: 'signup' } },
    { path: 'seeker', component:  SeekerComponent ,data: { animation: 'seeker' } },
